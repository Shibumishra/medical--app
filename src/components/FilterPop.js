...
class FilterPop extends Component {
  ...
  render() {
    ...
    return (
      <form className="mb-5" style={{ width: '80%', display: 'block' ,margin: 'auto'}}>
        <div className="form-row">
          ...
          <div className="form-group col-6 col-md-3">
            ...
            >
              <option> -- select an option -- </option>
              <option value={200}>Rs: 200 or less</option>
              <option value={300}>Rs: 300 or less</option>
              <option value={400}>Rs: 400 or less</option>
              <option value={500}>Rs: 500 or less</option>
              <option value={600}>Rs: 600 or less</option>
            </select>
          </div>
          <div className="form-group col-6 col-md-3">
